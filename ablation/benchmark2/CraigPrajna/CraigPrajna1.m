...
function CraigPrajna1(benchmark)
...
% a denotes coefficient of inv_poly.
...
function sdp_cons = SOSnew(pre_list,inv_poly,sdp_cons, epsilon, wi_deg)
    vars = sdp_cons{1};
    sdp_var = sdp_cons{2};
    constraints = sdp_cons{3};
    delta_cell  = sdp_cons{4}; 
    ...
    constraints = [constraints, sos( inv_poly - sum -epsilon)];
